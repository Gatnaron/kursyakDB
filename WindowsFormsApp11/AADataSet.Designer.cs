...
SELECT ID_Advertiser, Title, Surname, Name, Patronymic, ID_City FROM Advertiser WHERE (ID_Advertiser = @ID_Advertiser)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ID_Advertiser, Title, Surname, Name, Patronymic, ID_City FROM dbo.Advertis" +
                "er";
        ...
        public virtual int FillBy(AADataSet.AdvertiserDataTable dataTable) {
